...
$gconfig['path']['shop_photo'] = C_ROOT.'/photo/shop';//店铺二维码照片
...
$gconfig['path']['photo_shop_show'] = $_SERVER['HTTP_HOST'].'/cnflycms/photo/shop';
$gconfig['path']['photo_erecord_show'] = $_SERVER['HTTP_HOST'].'/cnflycms/photo/erecord';
