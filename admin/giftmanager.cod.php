...
<!-- content -->
<div class="gcontent" id="gigtmanager">
  <ul class="am-nav am-nav-pills ubread">
    <li class="am-active"><a href="javascript: void(0);">礼品管理</a></li>
  </ul>
  ...
  <div class="utools">
    ...
    <button class="am-btn ubtn-sure ubtn-blue" data-am-modal="{target:'#ugiftmanagerm1'}">
...
<!-- 增加礼品弹出框 -->
<div id="ugiftmanagerm1" class="am-modal" tabindex="-1">
