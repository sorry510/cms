<ul id="uleftbar" class="am-nav">
  <li><a href="member.php"><span class="iconfont icon-wsmp-payuser"></span> 会员</a></li>
  <li><a href="appoint.php"><span class="iconfont icon-clock"></span> 预约</a></li>
  <li><a href="detail.php"><span class="iconfont icon-ziliao"></span> 明细</a></li>
  <li><a href="count.php"><span class="iconfont icon-baobiao-xianxing"></span> 统计</a></li>
  ...
  <li class="am-dropdown" data-am-dropdown><a href="javascript:;" class="am-dropdown-toggle" data-am-dropdown-toggle><span class="iconfont icon-jifen-xianxing"></span> 收支</a>
  ...
  <li class="am-dropdown" data-am-dropdown><a href="javascript:;" class="am-dropdown-toggle" data-am-dropdown-toggle><span class="iconfont icon-kucun"></span> 库存</a>
  ...
  <li class="am-dropdown" data-am-dropdown>
    ...
    <ul class="am-dropdown-content umenu2 umenu2-seven">
      ...
      <li><a href="system_package.php"><span class="iconfont icon-question"></span> 套餐设置</a></li>
