...
<!-- content -->
<div class="gcontent" id="umarketing_reduction">
  ...
  <table class="am-table am-table-bordered am-table-hover am-table-compact utable1">
    ...
    <tbody>
      <tr>
        ...
        <td>机会难得，赶紧来购吧</td>
        <td>
          <button class="am-btn ubtn-table ubtn-green" data-am-modal="{target:'#umarketing_reductionm2'}">
...
<!-- 弹出框 -->
<div id="umarketing_reductionm1" class="am-modal" tabindex="-1">
...
<div id="umarketing_reductionm2" class="am-modal" tabindex="-1">
  <div class="am-modal-dialog umodal umodal-simple">
