...
<div class="gcontent" id="umember">
  <ul class="am-nav am-nav-pills ubread">
	  <li class="am-active"><a href="member.php">会员管理</a></li>
	  <li><a href="#">过期会员</a></li>
	  <li><a href="#">回收站</a></li>
  </ul>
            ...
            <div class="am-form-group">
              ...
              <div class="umodal-normal am-text-left">
                <label class="am-radio-inline">
                  <input type="radio" name="radio1" value="0" data-am-ucheck checked> 男
                </label>
                <label class="am-radio-inline">
    ...
    <div class="am-modal-bd">
      <div class="am-g ucontent">
        ...
        <div class="am-u-lg-4">会员卡类型：
          <select data-am-selected class="uselect uselect-auto">
