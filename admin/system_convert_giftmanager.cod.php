...
<!-- content -->
<div class="gcontent" id="system_convert_giftmanager">
  <ul class="am-nav am-nav-pills ubread">
    <li><a href="system_convert.php">积分换礼</a></li>
  ...
  <div class="utools">
    ...
    <button class="am-btn ubtn-sure ubtn-blue" data-am-modal="{target:'#usystem_convert_giftmanagerm1'}">
  ...
  <table class="am-table am-table-bordered am-table-hover am-table-compact utable1">
    ...
    <tbody>
      <tr>
        ...
        <td>888积分</td>
        <td>
          <button class="am-btn ubtn-table ubtn-green"  data-am-modal="{target:'#usystem_convert_giftmanagerm2'}">
...
<!-- 增加礼品弹出框 -->
<div id="usystem_convert_giftmanagerm1" class="am-modal" tabindex="-1">
...
<!-- 修改礼品弹出框 -->
<div id="usystem_convert_giftmanagerm2" class="am-modal" tabindex="-1">
  <div class="am-modal-dialog umodal umodal-simple">
