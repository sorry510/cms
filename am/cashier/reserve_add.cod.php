	...
	<div class="layui-row">		
		<div class="layui-col-xs6" style="padding-top:10px;">
		    ...
		    <div class="layui-inline">
		      <button type="button" class="layui-btn layui-btn-normal laimi-search">搜索</button>
				...
				<div class="layui-inline" style="margin-left:20px;">
					卡号：<span class="laimi-color-ju laimi-code" style="font-weight:bold;font-size:16px;">--</span>
				</div>
	  	</div>
			<div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      ...
		      <input class="layui-input laimi-input-200" type="hidden" name="txtcard_id">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label"><span>*</span>人数</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" value="" type="text" name="txtcount">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label"><span>*</span>手机</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-200" type="text" name="txtphone1">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label"><span>*</span>到店时间</label>
		    <div class="layui-input-inline">
		      <input name="txtdtime" id="laimi-time" class="layui-input laimi-input-200" type="text" placeholder="yyyy-MM-dd HH:mm:ss">
		    </div>
			</div>
			<div class="layui-form-item">
	  	...
	  	<div class="layui-form-item">
	    	<div class="layui-input-block">
		      <button class="layui-btn laimi-button-100 laimi-submitadd" lay-filter="laimi-submitadd" lay-submit>
		      	完成
		      </button>
					...
					<div class="layui-tab-item layui-show" style="overflow-y:auto; height:400px;">
                        ...
                        <option value="<?php echo $row['mgoods_catalog_id']; ?>"><?php echo $row['mgoods_catalog_name']; ?></option>
                      	<?php } ?>
										...
										<div class="layui-input-inline">
											<input class="layui-input laimi-input-200" type="text" name="txtsearch" placeholder="商品名称/编码">
										</div>
										<div class="layui-inline">
