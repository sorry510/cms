...
<?php echo $this->fun_fetch('inc_left', ''); ?>
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				...
				<div id="laimi-main" class="p-store-add layui-tab-content">
		...
		<div class="layui-col-xs5" style="padding-top:10px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" name="txttype" value="1" title="入库" lay-verify="radio">
					<input type="radio" name="txttype" value="2" title="出库" lay-verify="radio">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-100" placeholder="￥" type="text" name="txtmoney" lay-verify="number">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">经办人</label>
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-200" type="text" name="txtoperator">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn laimi-button-100 laimi-add-do" lay-filter="laimi-submit-add" lay-submit>
						确认
					</button>
          ...
          ?>
					<tr class="laimi-tr-mgoods" goods_catalog_id="<?php echo $row['mgoods_catalog_id']; ?>" goods_id="<?php echo $row2['mgoods_id']; ?>" goods_code="<?php echo $row2['mgoods_code']; ?>" goods_name="<?php echo $row2['mgoods_name']; ?>" goods_jianpin="<?php echo $row2['mgoods_jianpin']; ?>">
						...
						<td style="padding:5px">
							<div class="layui-inline">
								<input class="layui-input laimi-input-60-32" type="text" name="mycount[]" value="">
							</div>	
						</td>
					</tr>
					<?php
	...
	layui.use(["layer", "element", "laydate", "form"], function() {
		...
		objform.verify({
			radio: function(value, item) {
				var obj = $("#laimi-main input:radio[name='txttype']:checked");
				if(obj.length == 0) {
					return '请选择类型！';
				}
			}
		...
		$(".laimi-add-do").on("click", function() {
		  ...
		  $.post("store_add_do.php", objdata, function(strdata) {
		    if(strdata == 0) {
