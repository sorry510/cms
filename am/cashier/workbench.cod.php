			    	...
			    	<table class="layui-table" style="margin-top:0px;" lay-skin="line">
						  ...
						  <?php foreach($this->_data['mgoods_list'] as $row) { ?>
						    ...
						    <tr class="laimi-goods" gtype="m" catalog="<?php echo $row['mgoods_catalog_id']; ?>" gcode="<?php echo $row2['mgoods_code']; ?>" gname="<?php echo $row2['mgoods_name']; ?>" gshort="<?php echo $row2['mgoods_jianpin']; ?>" price="<?php echo $row2['mgoods_price']; ?>" gid="<?php echo $row2['mgoods_id']; ?>" act="<?php echo $row2['mgoods_act']; ?>">
						      ...
						      <td>
					      		<span>¥<?php echo $row2['mgoods_price']; ?><!-- &nbsp;<span class="laimi-color-ju">¥0</span> -->
						      </td>
						      <td>
			...
			<form class="layui-form" lay-filter="pay">
			  <div class="layui-form-item">
			  	...
			  	<div class="layui-field-box" style="font-size:16px;background-color:#FFFFDD;height:55px;padding-top:25px;border:1px solid #FCEFA1;margin-top:10px;">
					    ...
					    <div class="layui-row">
						    <div class="layui-col-md4">
						    	<div class="layui-form-mid">
						    		<input type="radio" name="paytype" value="5" lay-filter="paytype" title="会员卡（余¥{{d.card.s_card_ymoney || '0.00'}}）"
						    ...
						    <div class="layui-col-md3">
						    	<div class="layui-form-mid">
						    		<input type="radio" name="paytype" value="2" title="POS刷卡" lay-filter="paytype">
						    	</div>
						    </div>
						    <div class="layui-col-md5">
						    	<div class="layui-form-mid" style="margin-right:0px;">
						    		<input type="radio" name="paytype" value="1" lay-filter="paytype" title="现金" 
										{{# if(d.card.s_card_ymoney == undefined || d.card.s_card_ymoney - d.money < 0.001){ }}
						    			checked
						    		{{# } }}
						    		>
						    ...
						    <div class="layui-col-md4">
						      <input type="radio" name="paytype" value="4" title="支付宝扫码" lay-filter="paytype">
						    </div>
						    <div class="layui-col-md3">
						      <input type="radio" name="paytype" value="3" title="微信扫码" lay-filter="paytype">
						    </div>
						    <div class="layui-col-md5">
						      <input type="radio" name="paytype" value="6" title="团购" lay-filter="paytype">
						    </div>
					    </div>
					  </div>
					</fieldset>
					...
					{{# } }}
					<div class="layui-field-box" style="font-size:14px;border:1px solid #F0F0F0;margin-top:20px;">
					  <label class="layui-form-label" style="text-align:left;width:60px;padding-left:10px;">付款码</label>
				  ...
				  <div class="layui-field-box">
				    <div class="layui-row">
					    <div class="layui-col-md2">
					    	<div class="layui-form-mid">
					    		<input type="radio" name="paytype" value="4" title="支付宝" lay-filter="czpaytype">
					    	</div>
					    </div>
					    <div class="layui-col-md2">
					    	<div class="layui-form-mid">
					    		<input type="radio" name="paytype" value="3" title="微信" lay-filter="czpaytype">
					    	</div>
					    </div>
					    <div class="layui-col-md5">
					    	<div class="layui-form-mid" style="margin-right:0px;">
					    		<input type="radio" name="paytype" value="1" title="现金" lay-filter="czpaytype" checked>
					    	</div>
					    	<div class="layui-form-mid">
					    ...
					    <div class="layui-col-md3">
					    	<div class="layui-form-mid">
					    		<input type="radio" name="paytype" value="2" title="POS刷卡" lay-filter="czpaytype">
					    	</div>
					    </div>
				    </div>
				  </div>
	...
	<script type="text/html" id="laimi-script-add4">
		<div id="laimi-modal-add4" class="laimi-modal">
			<form class="layui-form" lay-filter="card-info">
				<div class="layui-row">
					 <div class="layui-col-md3">
				      	<img src="pub_image_file.php?type=card-photo&file={{d.card_photo_file}}" style="width:180px;height:180px;">
				    </div>
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laydate", "upload", "layer", "form", "laytpl"], function() {
	  ...
	  function ali_pay(type, paydata, objdata){
	  	var url = 'http://'+window.location.host+'/paysdk/ali_pay/dangmianfu/f2fpay/barpay.php';
    ...
    function wx_pay(type, paydata, objdata){
	  ...
	  (function init(){
	    ...
	    // 付款方式
	    objform.on('radio(czpaytype)', function(data){
	    	if(data.value == 4 || data.value == 3){
	    		$('#laimi-modal-recharge .laimi-pay-code').focus();
	    		// $('#laimi-modal-bill .laimi-pay-code').val()
	    	}
	    });
	    //修改会员卡类型
	    ...
	    $(document).on("input propertychange", "#laimi-modal-recharge .laimi-smoney", function(){
	    	if(isNaN($(this).val())){
	    		...
	    		$('#laimi-modal-recharge .laimi-rmoney').val($(this).val());
	    	}
	    ...
	    objform.on('radio(paytype)', function(data){
	    	if(data.value == 4 || data.value == 3){
	    		$('#laimi-modal-bill .laimi-pay-code').focus();
	    	}
	    });
