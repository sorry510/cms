			    	...
			    	<table class="layui-table" style="margin-top:0px;" lay-skin="line">
						  ...
						  <?php foreach($this->_data['mcombo_list'] as $row) { ?>
						      ...
						      <td style="text-align:left;" class="laimi-color-lan">
						       ...
						       <td>
						      	<span>¥<?php echo $row['mcombo_price']; ?></span>
						       </td>
						       <td>
					  ...
					  <div class="layui-field-box">
					    <div class="layui-row">
						    ...
						    <div class="layui-col-md3">
						    	<div class="layui-form-mid">
						    		<input type="radio" name="paytype" value="2" lay-filter="paytype" title="POS刷卡">
						    	</div>
						    </div>
						    ...
						    <div class="layui-col-md4">
						      <input type="radio" name="paytype" lay-filter="paytype" value="4" title="支付宝扫码">
						    </div>
						    <div class="layui-col-md3">
						      <input type="radio" name="paytype" lay-filter="paytype" value="3" title="微信扫码">
						    </div>
						    <div class="layui-col-md5">
						      <input type="radio" name="paytype" lay-filter="paytype" value="6" title="团购">
						    </div>
					    </div>
					  </div>
					</fieldset>
