	...
	<div class="layui-row">
		<div class="layui-col-xs6" style="padding-top:10px;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="laimi-from" class="layui-input" type="text" name="txtstart" placeholder="yyyy-MM-dd" lay-verify="required">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="laimi-to" class="layui-input" type="text" name="txtend" placeholder="yyyy-MM-dd" lay-verify="required">
				</div>
				<div class="layui-form-mid layui-word-aux">
					当天24点结束活动
				</div>
	              ...
	              ?>
								<tr class="laimi-tr-mgoods" mgoods_catalog_id="<?php echo $row['mgoods_catalog_id']; ?>" mgoods_id="<?php echo $row2['mgoods_id']; ?>" mgoods_price="<?php echo $row2['mgoods_price'] + 0; ?>">
									...
									<td style="padding:5px">
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="mydiscount[]" placeholder="折" mgoods_price="<?php echo $row2['mgoods_price'] + 0; ?>">
										</div>
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="myprice[]" placeholder="￥" mgoods_price="<?php echo $row2['mgoods_price'] + 0; ?>">
										</div>
						...
						<table class="layui-table" style="margin:0;">
							...
							<tbody>
								...
								<tr class="laimi-tr-mcombo" mcombo_id="<?php echo $row['mcombo_id']; ?>" mcombo_price="<?php echo $row['mcombo_price'] + 0; ?>">
									...
									<td style="padding:5px;">
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="mydiscount[]" placeholder="折" mcombo_price="<?php echo $row['mcombo_price'] + 0; ?>">
										</div>
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="myprice[]" placeholder="￥" mcombo_price="<?php echo $row['mcombo_price'] + 0; ?>">
										</div>
										<div class="layui-inline">元</div>
									</td>
								</tr>
...
<?php echo $this -> fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laydate", "layer", "form"], function() {
		...
		objform.on("submit(laimi-submit-add)", function(objdata) {
		  ...
		  $.post("act_discount_add_do.php", objdata, function(strdata) {
		    if(strdata == 0) {
		      ...
		      objlayer.alert("添加打折活动失败，请联系管理员！", {
						title: '提示信息'
					});
		      $(".laimi-add").attr("disabled", false);
		    }
