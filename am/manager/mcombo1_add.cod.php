		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					...
					<li class="layui-this">
						<a href="mcombo1_add.php">新增计次套餐</a>
					</li>
				</ul>
				<div id="laimi-main" class="p-mcombo1-add layui-tab-content">
	                 ...
	                 if ($row['mgoods_catalog_id'] == $row2['mgoods_catalog_id']) {
								...
								<tr class="laimi-tr-mgoods" mgoods_catalog_id="<?php echo $row['mgoods_catalog_id'];?>" mgoods_id="<?php echo $row2['mgoods_id'];?>">
									...
									<td style="padding-top:5px; padding-bottom:5px;">
										<input class="layui-input laimi-input-60-32 laimi-count" type="text" name="mycount[]" mgoods_id="<?php echo $row2['mgoods_id'];?>">
									</td>
								</tr>
								<?php
										}
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["layer", "element", "form"], function() {
		...
		$(".laimi-add").on("click", function() {
		  ...
		  $.post("mcombo1_add_do.php", objdata, function(strdata) {
		    if(strdata == 0) {
		      ...
		      objlayer.alert("新增计次套餐失败，请联系管理员！", {
						title: '提示信息'
					});
		      $(".laimi-add").attr("disabled", false);
		    }
