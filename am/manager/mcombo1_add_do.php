...
if($intreturn == 0) {
	...
	. "mcombo_limit_days, mcombo_limit_months, mcombo_act, mcombo_state, mcombo_atime ,mcombo_ctime) VALUES (1, '" . $sqlcode . "', '" . $sqlname . "', '" . $sqljianpin
	...
	if(!empty($arr1)) {
		foreach ($arr1 as $row) {
			...
			if($intmgoods > 0 && $intcount > 0) {
				...
				. $strid . ", ". $intmgoods . ", " . $intcount . ", " . $inttime . ", 0)";
				$gdb->fun_do($strsql);
			}
		}
	}
