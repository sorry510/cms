		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					<li>
						<a href="mcombo1.php">计次套餐</a>
					</li>
					<li class="layui-this">
						<a href="mcombo1_edit.php?id=<?php echo $GLOBALS['intid']; ?>">修改计次套餐</a>
					</li>
				</ul>
				<div id="laimi-main" class="p-mcombo1-edit layui-tab-content">
	...
	<div class="layui-row">
		<div class="layui-col-xs6" style="padding-top:10px;">
		    ...
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-200" type="text" name="txtname" value="<?php echo $this->_data['mcombo_info']['mcombo_name']; ?>" lay-verify="required">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label">简拼</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-80" type="text" name="txtjianpin" value="<?php echo $this->_data['mcombo_info']['mcombo_jianpin']; ?>">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label">套餐编码</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-200" type="text" name="txtcode" value="<?php echo $this->_data['mcombo_info']['mcombo_code']; ?>">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label"><span>*</span> 套餐价格</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtprice" value="<?php echo $this->_data['mcombo_info']['mcombo_price'] + 0; ?>" placeholder="￥" lay-verify="number">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtcprice" value="<?php echo $this->_data['mcombo_info']['mcombo_cprice'] + 0; ?>" placeholder="￥">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtdays" value="<?php echo $this->_data['mcombo_info']['mcombo_limit_days']; ?>">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input type="radio" name="txtact" value="1" title="参与活动"<?php if ($this->_data['mcombo_info']['mcombo_act'] == 1) echo " checked"; ?>>
		      <input type="radio" name="txtact" value="2" title="不参与"<?php if ($this->_data['mcombo_info']['mcombo_act'] == 2) echo " checked"; ?>>
		  	</div>
	                 ...
	                 if ($row['mgoods_catalog_id'] == $row2['mgoods_catalog_id']) {
								...
								<tr class="laimi-tr-mgoods" mgoods_catalog_id="<?php echo $row['mgoods_catalog_id']; ?>" mgoods_id="<?php echo $row2['mgoods_id']; ?>">
									...
									<td style="padding-top:5px; padding-bottom:5px;">
										<input class="layui-input laimi-input-60-32 laimi-count" type="text" name="mycount[]" value="<?php echo $row2['mcombo_goods_count']; ?>" mgoods_id="<?php echo $row2['mgoods_id']; ?>">
									</td>
								</tr>
								<?php
										}
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["layer", "element", "form"], function() {
		...
		$(".laimi-edit").on("click", function() {
		  ...
		  var obj1 = new Object();
		  $("#laimi-main .laimi-tr-mgoods").each(function() {
		    if($(this).find("input[name='mycount[]']").val() != "") {
		      obj1 = {"mgoods_id":$(this).attr("mgoods_id"),"count":$(this).find("input[name='mycount[]']").val()};
		    	arr1.push(obj1);
		    }
		  });
		  if(arr1.length == 0) {
		  ...
		  $.post("mcombo1_edit_do.php", objdata, function(strdata) {
		    if(strdata == 0) {
		      window.location="mcombo1.php";
		    } else if(strdata == 2) {
		      ...
		      objlayer.alert("修改计次套餐失败，请联系管理员！", {
						title: '提示信息'
					});
