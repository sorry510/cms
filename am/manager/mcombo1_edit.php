...
function get_mgoods() {
	$arr = array();
	$strsql = "SELECT a.*, b.mcombo_goods_count FROM " . $GLOBALS['gdb']->fun_table2('mgoods')
	. " AS a LEFT JOIN (SELECT mcombo_goods_id, mgoods_id, mcombo_goods_count FROM " . $GLOBALS['gdb']->fun_table2('mcombo_goods') . " WHERE mcombo_id = " . $GLOBALS['intid']
