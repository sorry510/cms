...
function get_mcombo_list() {
	...
	$strwhere = '';
	$strwhere = $strwhere . " AND mcombo_type = 2";
	if($GLOBALS['strkey'] != "") {
	...
	$strsql = "SELECT mcombo_id, mcombo_code, mcombo_name, mcombo_jianpin, mcombo_price, mcombo_cprice, mcombo_limit_days, mcombo_act, mcombo_state, mcombo_atime FROM "
	. $GLOBALS['gdb']->fun_table2('mcombo') . " WHERE 1 = 1" . $strwhere . " ORDER BY mcombo_id DESC LIMIT " . $intoffset . ", " . $intpagesize;
	$hresult = $GLOBALS['gdb']->fun_query($strsql);
