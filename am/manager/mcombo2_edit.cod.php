		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					...
					<li class="layui-this">
						<a href="mcombo2_edit.php?id=<?php echo $GLOBALS['intid']; ?>">修改计时套餐</a>
					</li>
				</ul>
				<div id="laimi-main" class="p-mcombo2-edit layui-tab-content">
	                 ...
	                 if ($row['mgoods_catalog_id'] == $row2['mgoods_catalog_id']) {
								...
								<tr class="laimi-tr-mgoods" mgoods_catalog_id="<?php echo $row['mgoods_catalog_id']; ?>" mgoods_id="<?php echo $row2['mgoods_id']; ?>">
									...
									<td style="padding-top:5px; padding-bottom:5px;">
										<input type="checkbox" name="mymgoods[]" mgoods_id="<?php echo $row2['mgoods_id'];?>" lay-skin="primary"<?php if(!empty($row2['mcombo_goods_id'])) echo ' checked'; ?>> 选择
									</td>
								</tr>
								<?php
										}
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["layer", "element", "form"], function() {
		...
		$(".laimi-edit").on("click", function() {
		  ...
		  $.post("mcombo2_edit_do.php", objdata, function(strdata) {
		    if(strdata == 0) {
		      ...
		      objlayer.alert("修改计时套餐失败，请联系管理员！", {
						title: '提示信息'
					});
