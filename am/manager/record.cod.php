...
<form class="layui-form">
	<div class="laimi-tools layui-form-item">
		...
		<div class="layui-input-inline last">
			<input class="layui-input laimi-input-100 laimi-focus" type="text" name="key" placeholder="卡号/手机号/姓名" value="<?php echo htmlspecialchars($GLOBALS['strkey']); ?>" style="width:125px;">
		</div>
		<div class="layui-input-inline">
