	...
	<div class="laimi-tools layui-form-item">
		...
		<div class="layui-input-inline">
			<select name="shop">
				...
				<option value="<?php echo $row['shop_id']; ?>"<?php if($GLOBALS['intshop'] == $row['shop_id']) echo ' selected'; ?>><?php echo $row['shop_name']; ?></option>
				<?php } ?>
			</select>
		</div>
		<div class="layui-input-inline">
		...
		<div id="laimi-modal-add" class="laimi-modal">
			<form class="layui-form" lay-filter="laimi-form-add">
			    ...
			    <div class="layui-input-block">
			      <input type="radio" name="txttype" value="1" title="管理员" lay-verify="radio">
		...
		objform.verify({
			radio: function(strvalue, objitem) {
				...
				if(obj.length == 0) {
					...
					if((obj.val() == 2 || obj.val() == 3) && $("#laimi-modal-add select[name='txtshop']").val() == "") {
						return '请选择所属分店！';
					}
				}
			},
