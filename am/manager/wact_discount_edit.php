...
function get_edit(){
	$arr = array();
	$strsql = "SELECT wact_discount_id, wact_discount_name, wact_discount_client, wact_discount_start, wact_discount_end, wact_discount_memo FROM" . $GLOBALS['gdb']->fun_table2('wact_discount') . " WHERE wact_discount_id = ".$GLOBALS['intid'];
