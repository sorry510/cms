			...
			<div id="laimi-content" class="layui-body">
				<div class="layui-tab layui-tab-brief">
					<ul class="layui-tab-title">
						<li class="layui-this"><a href="javascript;">新增商城商品</a></li>
					</ul>
					<div class="layui-tab-content">
						<form class="layui-form" id="laimi-form2" action="wechat_shop_manage_add_do.php" method="post">
						  <div class="layui-form-item">
						    <label class="layui-form-label">商品分类</label>
						    <div class="layui-input-block laimi-input-200">
							    <select name="txtwgoods_catalog_id" lay-verify="required" lay-search="">
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="text" name="txtwgoods_name" autocomplete="off" class="layui-input laimi-input-300">
						    </div>
						    <div class="layui-input-inline">
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="text" name="txtwgoods_name2" autocomplete="off" class="layui-input laimi-input-300">
						    </div>
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="text" name="txtwgoods_code" autocomplete="off" class="layui-input laimi-input-200">
						    </div>
						  ...
						  <div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="txtwgoods_price" placeholder="￥" autocomplete="off" class="layui-input laimi-input-80">
								</div>
						  ...
						  <div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="txtwgoods_cprice" placeholder="￥" lay-verify="title" autocomplete="off" class="layui-input laimi-input-80">
								</div>
								<div class="layui-form-mid layui-word-aux">元</div>	
						  </div>
						  <div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="txtwgoods_store" lay-verify="title" autocomplete="off" class="layui-input laimi-input-80">
								</div>
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="radio" name="txtwgoods_act" value="2" title="不参与" checked>
								  <input type="radio" name="txtwgoods_act" value="1" title="参与活动">
							  </div>
							</div>
							<div class="layui-form-item">
						    <label class="layui-form-label">是否推荐</label>
						    <div class="layui-input-inline">
						      <input type="radio" name="txtwgoods_commend" value="2" title="不推荐" checked>
								  <input type="radio" name="txtwgoods_commend" value="1" title="推荐">
							  </div>
							</div>
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-block" style="width: 70%;">
						      <!-- 加载编辑器的容器 -->
							    <script id="container" name="txtwgoods_content" type="text/plain"></script>
							    <!-- 配置文件 -->
	...
	layui.use(["element", "laydate", "laypage", "upload", "layer", "form"], function() {
	  ...
	  $("#laimi-add").on("click", function() {
		...
		objform.on("submit(laimi-submit)", function(data) {
			...
			$.post('wechat_shop_manage_add_do.php', data.field, function(msg){
			  console.log(msg);
			  if(msg == 0){
			    window.location.href='wechat_shop_manage.php';
			  }else if(msg == 2){
			  	objlayer.alert('编码不能重复', {
						title: '提示信息'
					});
			  }else{
