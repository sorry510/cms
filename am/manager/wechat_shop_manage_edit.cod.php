			...
			<div id="laimi-content" class="layui-body">
				<div class="layui-tab layui-tab-brief">
					<ul class="layui-tab-title">
						<li class="layui-this"><a href="javascript;">修改商城商品</a></li>
					</ul>
					<div class="layui-tab-content">
						<form class="layui-form" id="laimi-form2" action="wechat_shop_manage_edit_do.php" method="post">
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="radio" name="txtwgoods_commend" value="2" title="不推荐" <?php if ($this->_data['edit']['wgoods_commend'] == 2) { echo "checked";};?>>
								  <input type="radio" name="txtwgoods_commend" value="1" <?php if ($this->_data['edit']['wgoods_commend'] == 1) { echo "checked";};?> title="推荐">
							  </div>
							</div>
						 			    ...
						 			    <table class="layui-table" style="width:80%;">
						 			      ...
						 			      <tbody id="showList">
							 			      	...
							 			      	<tr style="padding:3px;">
							 			      		<td><img src="<?php echo "http://weixin.test.laimisoft.com/upload/".$GLOBALS['_SESSION']['login_cid']."/wgoods_image/".$strp;?>" width="60" height="60"/></td>
							 			      		<td><?php echo $strp; ?></td>
							 			      		<td>--</td>
							 			      		<td>已存在</td>
	  ...
	  $("#laimi-edit").on("click", function() {
		...
		$(".laimi-del").on("click", function() {
			...
			objlayer.confirm('确定要删除该图片吗？', {icon:0, title:'提示', shadeClose:true}, function(hindex) {
				$.post('wechat_shop_manage_del_photo_do.php', {id:<?php echo $this->_data['edit']['wgoods_id']; ?>,key:objthis.attr("pkey")}, function(strdata) {
					if(strdata == 0) {
