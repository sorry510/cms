...
function get_edit() {
	$arr = array();
	$strsql = "SELECT wgoods_id,wgoods_catalog_id,wgoods_code,wgoods_name,wgoods_name2,wgoods_price,wgoods_cprice,wgoods_store,wgoods_act,wgoods_commend,wgoods_content,wgoods_photo1,wgoods_photo2,wgoods_photo3,wgoods_photo4,wgoods_photo5 FROM " . $GLOBALS['gdb']->fun_table2('wgoods')." where wgoods_id = ".$GLOBALS['intid'];
