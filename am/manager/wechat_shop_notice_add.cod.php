						...
						<form class="layui-form" action="">
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <input type="text" name="txtwnotice_title" autocomplete="off" class="layui-input" style="width:80%;" lay-verify="required">
						    </div>
						  </div>						  					  
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <!-- 加载编辑器的容器 -->
							    <script id="container" name="txtwnotice_content" type="text/plain"></script>
							    <!-- 配置文件 -->
						  ...
						  <div class="layui-form-item">
						    <div class="layui-input-block">
						      <button class="layui-btn laimi-button-100" lay-submit="" lay-filter="laimi-submitadd">确定</button>
						    </div>
						  </div>
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laydate", "laypage", "upload", "layer", "form"], function() {
		...
		objform.on("submit(laimi-submitadd)", function(data) {
		  ...
		  var url="wechat_shop_notice_add_do.php";
