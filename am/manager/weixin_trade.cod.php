		...
		<div class="layui-input-inline">
			<div class="layui-upload">
			  ...
			  <div class="layui-upload-list">
			    <img id="laimi-image" class="layui-upload-img" src="pub_image_file.php?type=weixin-card-image&file=<?php echo $this->_data['company_weixin']['card_image']; ?>" style="width:264px;height:165px;">
			    <p></p>
			  </div>
			</div>
		</div>
