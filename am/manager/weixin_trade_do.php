...
if($intreturn == 0) {
	...
	if($strimage != '') {
		$arrweixin['card_background'] = 'laimi.png';
	}
}
...
if($intreturn == 0) {
	if($strimage != '') {
		...
		$GLOBALS['gconfig']['path']['weixin'] . '/' . api_value_int0($GLOBALS['_SESSION']['login_cid']) . $GLOBALS['gconfig']['path']['card_background'] . '/laimi.png');
