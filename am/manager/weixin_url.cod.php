...
<style type="text/css">
#laimi-main textarea {line-height:22px;}
</style>
</head>
...
<?php echo $this->fun_fetch('inc_left', ''); ?>
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				...
				<div id="laimi-main" class="p-weixin-url layui-tab-content">
<form class="layui-form">													
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea class="layui-textarea laimi-input-b80" disabled>https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http%3A%2F%2Fshop1.e8860.com%2Ffw%2Fweixin%2Fs_oauth2.php%3Ftid%3D %26url%3Dm11.php&response_type=code&scope=snsapi_base#wechat_redirect</textarea>
		</div>
	</div>
	<div class="layui-form-item">
