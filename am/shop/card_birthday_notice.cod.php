			...
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					<li class="<?php if($this->_data['request']['state'] == 1) echo 'layui-this'; ?>">
						<a href="card_birthday_notice.php?state=1">今天生日</a>
					</li>
					<li class="<?php if($this->_data['request']['state'] == 2) echo 'layui-this'; ?>">
						<a href="card_birthday_notice.php?state=2">近三天生日</a>
					</li>
				</ul>
				<div id="laimi-main" class="p-card layui-tab-content">
<form class="layui-form">
	<input type="hidden" name="state" value="<?php echo $this->_data['request']['state']; ?>">
