			...
			<form class="layui-form" lay-filter="laimi-form-add">
				<div class="layui-row">
					<div class="layui-col-md6">
					    ...
					    <div class="layui-input-inline">
					    <div class="layui-form-mid layui-word-aux"><?php echo $GLOBALS['gshopname']; ?></div>
					    </div>
					  </div>
			    </div>
			    <div class="layui-col-md6">
			...
			<input type="hidden" name="txtid" value="{{d.worker_id}}">
				<div class="layui-row">
					<div class="layui-col-md6">
						<div class="layui-form-item">
							<label class="layui-form-label"><span>*</span> 所属分店</label>
					    <div class="layui-input-inline">
					     <label class="layui-form-label"><?php echo $this->_data['shop_info']['shop_name']; ?></label>
					    </div>
					  </div>
			    </div>
			    <div class="layui-col-md6">
			    ...
			    <div class="layui-col-md6">
			      <div class="layui-form-item">
					    <label class="layui-form-label"><span>*</span> 手机号码</label>
					    <div class="layui-input-inline">
					      <input class="layui-input laimi-input-200" type="text" name="txtphone" value="{{d.worker_phone}}">
					    </div>
					  </div>
			    </div>
			    <div class="layui-col-md6">
			      <div class="layui-form-item">
					    ...
					    <div class="layui-input-inline">
					      <input id="laimi-birthday" class="layui-input laimi-input-200" type="text" name="txtbirthday" value="{{d.worker_birthday_date}}" placeholder="yyyy-MM-dd">
					    </div>
					  </div>
			    </div>
			    <div class="layui-col-md6">
			    ...
			    <div class="layui-col-md6">
			      <div class="layui-form-item">
					    <label class="layui-form-label">入职时间</label>
					    <div class="layui-input-inline">
					      <input id="laimi-join" class="layui-input laimi-input-200" type="text" name="txtjoin" value="{{d.worker_join}}" placeholder="yyyy-MM-dd">
					    </div>
					  </div>
			    </div>
			    <div class="layui-col-md6">
			    ...
			    <div class="layui-col-md6">
			      <div class="layui-form-item">
					    <label class="layui-form-label">基本工资</label>
					    <div class="layui-input-inline">
					      <input class="layui-input laimi-input-80" type="text" name="txtwage" value="{{d.worker_wage}}" placeholder="￥">
					    </div>
					    <div class="layui-form-mid layui-word-aux">元</div>
					  </div>
			    </div>
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	<script>
	layui.use(["layer", "element", "laydate", "laypage", "upload", "laytpl", "form"], function() {
		var $ = layui.jquery;
		...
		$(".laimi-info").on("click", function() {
			$.getJSON('worker_info_ajax.php', {id:$(this).attr('wid')}, function(res){
				objlaytpl($("#laimi-script-info").html()).render(res, function(html){
				  objlayer.open({
				  	type: 1,
