...
if($intreturn == 0) {
	...
	. " worker_state, worker_atime, worker_ctime) VALUES (" . $intgroup . ", " . api_value_int0($GLOBALS['_SESSION']['login_sid']) . ", '" . $sqlcode . "', '" . $sqlname . "', "
	. $intsex . ", " . $intbirthday . ", " . $intmonth . ", " . $intday . ", '" . $sqlphone . "', '', '" . $sqlidentity . "', '', " . $inteducation . ", " . $intjoin . ", '"
	. $sqladdress . "', " . $decwage . ", 1, " . time() . ", 0)";
