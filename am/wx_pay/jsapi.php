...
$arrwpay = laimi_config_wpay(api_value_int0($GLOBALS['_SESSION']['login_cid']));//$arrwpay名字不能改
require_once C_ROOT . "/wx_pay/lib/WxPay.Api.php";
require_once C_ROOT . "/wx_pay/WxPay.JsApiPay.php";
...
// echo $GLOBALS['_SESSION']['login_sid'];exit;
$intparent_id = 0;
...
$input->SetNotify_url('http://'.$_SERVER['HTTP_HOST'].'/'.$GLOBALS['_SESSION']['login_code'].'/notify.php');
