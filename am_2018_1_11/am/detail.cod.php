	...
	<div id="slider" class="mui-slider" >
		<div class="mui-slider-group mui-slider-loop">
			...
			<div class="mui-slider-item mui-slider-item-duplicate">
				<a href="javascript:;">
					<img src="../upload/<?php echo api_value_int0($GLOBALS['_SESSION']['login_cid']); ?>/wgoods_image/<?php echo $this->_data['detail']['photo'][0];?>">
				</a>
			</div>
			<!-- 第一张 -->
			...
			<div class="mui-slider-item">
				<a href="javascript:;">
					<img src="../upload/<?php echo api_value_int0($GLOBALS['_SESSION']['login_cid']); ?>/wgoods_image/<?php echo $row;?>">
				</a>
			</div>
			<?php };?>
  ...
  wx.config({
	...
	wx.ready(function() {
		wx.onMenuShareTimeline({
			title: "分享测试", // 分享标题
			link: "<?php echo $GLOBALS['gconfig']['project']['url_mobile'];?>/wx_share.php?goto=3&id=<?php echo $GLOBALS['strid']; ?>&cid=<?php echo $GLOBALS['_SESSION']['login_cid']; ?>&uid=<?php echo $GLOBALS['_SESSION']['login_id']; ?>", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
