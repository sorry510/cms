...
// $openid = $GLOBALS['_SESSION']['login_openid'];
// var_dump($openid);exit;
// if(empty($openid)){
// 	header("Location: https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxbeda5ab3d65c0ab1&redirect_uri=".$GLOBALS['gconfig']['project']['url_mobile']."/s_oauth2.php?goto=3,1,".$strgoto."&response_type=code&scope=snsapi_base#wechat_redirect");
// 	return;
// }
// if($intid == 0){
// 	$arrgoto = explode(",", $strgoto);
// 	$intid = api_value_int0($arrgoto[0]);
// }
