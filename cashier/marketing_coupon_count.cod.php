...
<div id="umarketing_coupon" class="gcontent">
    ...
    <form class="am-form-inline uform1">
      <div class="am-form-group">
        ...
        <select class="uselect uselect-auto" data-am-selected name="act_type">
          ...
          <option value="3" <?php if ($this->_data['request']['act_type'] == 3) {
           echo "selected='selected'";
          }?>>满送活动</option>
          <option value="4" <?php if ($this->_data['request']['act_type'] == 4) {
           echo "selected='selected'";
          }?>>赠送优惠券</option>
        </select>
      </div>
      <div class="am-form-group">
        ...
        <select class="uselect uselect-auto" data-am-selected name="ttype">
          ...
          <option value="1" <?php if ($this->_data['request']['ttype'] == 1) {
           echo "selected='selected'";
          }?>>代金券</option>
          <option value="2" <?php if ($this->_data['request']['ttype'] == 2) {
           echo "selected='selected'";
          }?>>体验券</option>
        </select>
      </div>
  ...
  <table class="am-table am-table-bordered am-table-hover am-table-compact utable1" id="doc-modal-list">
    ...
    <?php foreach($this->_data['act_list']['list'] as $row) { ?>
      <tr>
  ...
  <ul class="am-pagination am-pagination-centered upages">
    <li class="upage-info">共<?php echo $this->_data['act_list']['pagecount']; ?>页 <?php echo $this->_data['act_list']['allcount']; ?>条记录</li>
    <li class="cfirst am-disabled"><a href="marketing_coupon_count.php?<?php echo api_value_query($this->_data['request'], $this->_data['act_list']['pagepre']); ?>">&laquo;</a></li>
    <li class="am-active"><a href="#"><?php echo $this->_data['act_list']['pagenow'];?></a></li>
    <li class="clast"><a href="marketing_coupon_count.php?<?php echo api_value_query($this->_data['request'], $this->_data['act_list']['pagenext']); ?>">&raquo;</a></li>
...
//分页首末页不可选中
if(<?php echo $this->_data['act_list']['pagenow'];?>>1){
  $('.upages li.cfirst').removeClass('am-disabled');
}
if(<?php echo $this->_data['act_list']['pagecount']-$this->_data['act_list']['pagenow']; ?><1){
...
function page_do() {
  ...
  if(isNaN(intpage)) {
    ...
    window.location = "marketing_coupon_count.php?<?php echo api_value_query($this->_data['request']); ?>&page=" + intpage;
  }
}
</script>
