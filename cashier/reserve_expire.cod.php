...
<div class="gcontent" id="ureserve">
  <ul class="am-nav am-nav-pills ubread">
    ...
    <li class="am-active"><a href="reserve_expire.php">过期预约</a></li>
  </ul>
  ...
  <div class="gspace15"></div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button class="am-btn ubtn-table ubtn-green chere" value="<?php echo $row['reserve_id']; ?>" <?php if ($row['reserve_here'] == 1 || $row['reserve_dtime']<strtotime(date('Y-m-d',time()))) {
          ...
          &nbsp;
          <button class="am-btn ubtn-table ubtn-green cedit" data-am-modal="{target: '#ureservem2'}" value="<?php echo $row['reserve_id']; ?>" <?php if ($row['reserve_here'] == 1 || $row['reserve_dtime']<strtotime(date('Y-m-d',time()))) {
            echo "style='display:none;'";
          } ;?>>
            <i class="iconfont icon-bianji"></i>
            修改
          ...
          <button class="am-btn ubtn-table <?php if ($row['reserve_state'] == 1) {
            echo " ubtn-red cstop";
          }else{echo " ubtn-green cstart";} ; ?> " value="<?php echo $row['reserve_id']; ?>" <?php if ($row['reserve_here'] == 1 || $row['reserve_dtime']<strtotime(date('Y-m-d',time()))) {
            echo "style='display:none;'";
          } ;?>>
...
$('.cedit').on('click', function(){
  ...
  $.getJSON(url,{id:data},function(msg){
      ...
      $.each(msg.reserve_goods, function (key,val) {
        if(val.mgoods_id !='0'){
          addhtml ='<li><div class="uc1">'+val.c_mgoods_name+'</div><div class="uc2"><input mgoods_id="'+val.mgoods_id+'" mgoods_name="'+val.c_mgoods_name+'" class="am-form-field uinput2 uinput-35 cnum" type="text" placeholder="" style="display:none;"></div><div class="uc3 cdel2" mgoods_id="'+val.mgoods_id+'"><a href="javascript:;">移除</a></div></li>';
        }
...
function cadd(){
  ...
  if(mgoods_id != undefined){
    addhtml ='<li><div class="uc1">'+product+'</div><div class="uc2"><input mgoods_id="'+mgoods_id+'" mgoods_name="'+mgoods_name+'" class="am-form-field uinput2 uinput-35 cnum" type="text" placeholder="" value="1" style="display:none;"></div><div class="uc3 cdel2" mgoods_id="'+mgoods_id+'"><a href="javascript:;">移除</a></div></li>';
  }
