...
<div class="gcontent" id="ureserve">
  <ul class="am-nav am-nav-pills ubread">
    ...
    <li class="am-active"><a href="reserve_tomrrow.php">明日预约</a></li>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          &nbsp;
          <button class="am-btn ubtn-table ubtn-green cedit" data-am-modal="{target: '#ureservem2'}" value="<?php echo $row['reserve_id']; ?>" <?php if ($row['reserve_here'] == 1) {
            echo "style='display:none;'";
          } ;?>>
            <i class="iconfont icon-bianji"></i>
            修改
          ...
          <button class="am-btn ubtn-table <?php if ($row['reserve_state'] == 1) {
            echo " ubtn-red cstop";
          }else{echo " ubtn-green cstart";} ; ?> " value="<?php echo $row['reserve_id']; ?>" <?php if ($row['reserve_here'] == 1) {
            echo "style='display:none;'";
          } ;?>>
