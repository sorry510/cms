...
$arr = array();
$strsql = 'SELECT ticket_goods_id,ticket_goods_begin,ticket_goods_name,ticket_goods_value,a.mgoods_id,ticket_goods_days,mgoods_name,ticket_goods_memo,ticket_goods_atime FROM' . $GLOBALS['gdb']->fun_table2('ticket_goods') . 'as a LEFT JOIN '. $GLOBALS['gdb']->fun_table2('mgoods').' as b on a.mgoods_id = b.mgoods_id WHERE ticket_goods_id ="'.$intid.'" ORDER BY ticket_goods_id DESC';
