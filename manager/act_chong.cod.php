		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					<li class="layui-this">
						<a href="act_chong.php">充值活动</a>
					</li>
					<li>
						<a href="act_chong.php?expire=1">已结束</a>
					</li>
				</ul>
				<div id="laimi-main" class="p-act-chong layui-tab-content">
<form class="layui-form">
	<div class="laimi-tools layui-form-item">
		...
		<div class="laimi-float-right">
			<a id="laimi-add" class="layui-btn">新增充值活动</a>
		</div>
	</div>
</form>
...
<div class="laimi-page">
	...
	<div id="laimi-modal-add" class="laimi-modal">
		<form class="layui-form">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><span>*</span> 充值金额</label>
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-100" type="text" name="txtchong" placeholder="￥">
				</div>
				<div class="layui-form-mid layui-word-aux">充值金额是指会员卡里实际充值金额</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"><span>*</span> 实收金额</label>
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-100" type="text" name="txtshi" placeholder="￥">
				</div>
				<label class="layui-form-label"><span>*</span> 赠送金额</label>
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-100" type="text" name="txtsong" placeholder="￥">
				</div>
			</div>
			<div class="layui-form-item">
