...
function get_record_history(){
	...
	if($GLOBALS['strsearch'] != '') {
		$strwhere = $strwhere . " AND (c_card_code = '" . $GLOBALS['strsearch'] . "'";
		$strwhere = $strwhere . " or c_card_name = '" . $GLOBALS['strsearch'] . "'";
		$strwhere = $strwhere . " or c_card_phone = '" . $GLOBALS['strsearch'] . "')";
	}
