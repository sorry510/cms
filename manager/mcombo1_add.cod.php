		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					...
					<li class="layui-this">
						<a href="mcombo2_add.php">新增计次套餐</a>
					</li>
				</ul>
	...
	<div class="layui-row">
		<div class="layui-col-xs6" style="padding-top:10px;">
		    ...
		    <div class="layui-input-inline">
		      <input id="laimi-comboname" class="layui-input laimi-input-200" type="text" name="txtmcombo_name" lay-verify="required">
		      <input id="laimi-comboname" class="layui-input laimi-input-200" type="hidden" name="txtmcombo_type" value="1">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label">简拼</label>
		    <div class="layui-input-inline">
		      <input id="laimi-upen" class="layui-input laimi-input-80" type="text" name="txtmcombo_jianpin">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label">套餐编码</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-200" type="text" name="txtmcombo_code">
		    </div>
			</div>
			<div class="layui-form-item">
		    <label class="layui-form-label"><span>*</span> 套餐价格</label>
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtmcombo_price" placeholder="￥" lay-verify="required">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtmcombo_cprice" placeholder="￥">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input class="layui-input laimi-input-100" type="text" name="txtmcombo_limit_days">
		    </div>
		    ...
		    <div class="layui-input-inline">
		      <input type="radio" name="txtmcombo_act" value="2" title="不参与" checked>
			  	<input type="radio" name="txtmcombo_act" value="1" title="参与活动">
		  	</div>
		    ...
		    <div class="layui-input-inline">
		      <input type="radio" name="txtmcombo_reserve" value="2" title="不参与" checked>
				  <input type="radio" name="txtmcombo_reserve" value="1" title="参与预约">
			  </div>
			</div>
	  	<div class="layui-form-item">
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "layer", "form"], function() {
		...
		objform.on("submit(laimi-submitadd)", function(data) {
		  ...
		  var arr = [];
		  $("#laimi-mcombo .laimi-mcombo input[name='mgoods_num']").each(function(){
		  	if ($(this).val() != '') {
