	...
	<div class="layui-row">
		<div class="layui-col-xs6" style="padding-top:10px;">
		    ...
		    <div class="layui-input-inline">
		      ...
		      <input class="layui-input laimi-input-200" type="hidden" name="txtmcombo_type" value="1">
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "layer", "form"], function() {
        ...
        $("#laimi-mcombo input[name='mgoods_num']").each(function() {
          if ($(this).attr('mgoods_id') == res[i].mgoods_id) {
            $(this).val(res[i].mcombo_goods_count);
          }
        })
	    }
	    objform.render();
