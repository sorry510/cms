...
$strmgoods_catalog_id = api_value_post('txtmgoods_catalog_id');
$intmgoods_catalog_id = api_value_int0($strmgoods_catalog_id);
$strmgoods_name = api_value_post('txtmgoods_name');
$sqlmgoods_name = $gdb->fun_escape($strmgoods_name);
$strmgoods_jianpin = api_value_post('txtjianpin');
$sqlmgoods_jianpin = $gdb->fun_escape($strmgoods_jianpin);
$strmgoods_code = api_value_post('txtmgoods_code');
$sqlmgoods_code = $gdb->fun_escape($strmgoods_code);
$strmgoods_price = api_value_post('txtmgoods_price');
$decmgoods_price = api_value_decimal($strmgoods_price,2);
$strmgoods_cprice = api_value_post('txtmgoods_cprice');
$decmgoods_cprice = api_value_decimal($strmgoods_cprice,2);
// $strmgoods_type = api_value_post('txtmgoods_type');
// $intmgoods_type = api_value_int0($strmgoods_type);
$strmgoods_act = api_value_post('txtmgoods_act');
$intmgoods_act = api_value_int0($strmgoods_act);
$strmgoods_reserve = api_value_post('txtmgoods_reserve');
$intmgoods_reserve = api_value_int0($strmgoods_reserve);
$strmgoods_id = api_value_post('txtmgoods_id');
