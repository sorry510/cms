...
<form class="layui-form">
	<div class="laimi-tools layui-form-item">
		...
		<div class="layui-input-inline">
			<input id="laimi-from" name="stime" class="layui-input laimi-input-100" type="text" placeholder="yyyy-MM-dd" value="<?php echo $this->_data['request']['stime']?>">
		</div>
		<label class="layui-form-label laimi-input" style="width: 0px;margin-right:10px">至</label>
		<div class="layui-input-inline">
			<input id="laimi-to" name="etime" class="layui-input laimi-input-100" type="text" placeholder="yyyy-MM-dd" value="<?php echo $this->_data['request']['etime']?>">
		</div>
...
<div class="laimi-page">
	...
	<script type="text/html" id="laimi-script-info">
		<div id="laimi-modal-info" class="laimi-modal">
		    ...
		    <div class="layui-col-md3" style="text-align:right;">
		    	<!-- <button class="layui-btn laimi-button-100 laimi-print" value="{{d.card_record_id}}">打印小票</button> -->
	...
	<script type="text/html" id="laimi-script-print">
		<div id="laimi-modal-info" class="laimi-modal">
			<div class="layui-row">
...
<?php echo $this->fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laypage", "layer", "form", "laytpl"], function() {
		...
		$(document).on("click", ".laimi-print", function() {
			$.getJSON('record_edit_ajax.php', {id:$(this).val()}, function(data){
				objlaytpl($("#laimi-script-print").html()).render(data, function(html){
				  objlayer.open({
				  	type: 1,
						title: ["打印明细", "font-size:16px;"],
						btnAlign: "r",
						area: ["480px", "auto"],
						shadeClose: true,//点击遮罩关闭
				  	content: html
