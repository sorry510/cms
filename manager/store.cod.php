...
<div class="gcontent" id="ustore">
    ...
    <?php foreach($this->_data['store_list']['list'] as $row) { ?>
      <tr>
        ...
        <td>
          ...
          <?php }else{?>
          <button type="button" class="am-btn ubtn-table ubtn-orange ccheck" value="<?php echo $row['store_id'];?>">
            <i class="iconfont icon-yuanxingxuanzhong"></i>
            已确认
          </button>
          <?php }?>
  ...
  <ul class="am-pagination am-pagination-centered upages">
    <li class="upage-info">共<?php echo $this->_data['store_list']['pagecount']; ?>页 <?php echo $this->_data['store_list']['allcount']; ?>条记录</li>
    <li class="am-disabled"><a href="store.php?<?php echo api_value_query($this->_data['request'], $this->_data['store_list']['pagepre']); ?>">&laquo;</a></li>
    <li class="am-active" ><a href="#"><?php echo $GLOBALS['intpage'];?></a></li>
    <li><a href="store.php?<?php echo api_value_query($this->_data['request'], $this->_data['store_list']['pagenext']); ?>">&raquo;</a></li>
  </ul>
</div>
...
if(<?php echo $this->_data['store_list']['pagecount']-$GLOBALS['intpage']; ?><1){
