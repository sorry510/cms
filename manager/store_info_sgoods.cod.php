...
<div class="gcontent" id="ustore_info_sgoods">
    ...
    <form class="am-form-inline uform">
      ...
      <div class="am-form-group">
        ...
        <select class="uselect uselect-auto" data-am-selected name="sgoods_catalog_id">
          ...
          <option value="<?php echo $row['sgoods_catalog_id'] ?>" <?php if($row['sgoods_catalog_id'] == $this->_data['sgoods_catalog_id']){echo "selected";} ?> ><?php echo $row['sgoods_catalog_name'] ?></option>
          <?php } ?>
        </select>
      </div>
      <div class="am-form-group">
  ...
  <ul class="am-pagination am-pagination-centered upages">
    ...
    <li><a href="store_info_sgoods.php?page=<?php echo $this->_data['store_info_sgoods_list']['pagepre']; ?>">&laquo;</a></li>
    <li class="am-active" ><a href="#"><?php echo $GLOBALS['intpage'];?></a></li>
    <li><a href="store_info_sgoods.php?page=<?php echo  $this->_data['store_info_sgoods_list']['pagenext']; ?>">&raquo;</a></li>
  </ul>
</div>
