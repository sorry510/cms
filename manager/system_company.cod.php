...
<div class="gcontent" id="usystem_company">
  ...
  <div class="am-g ua">
    ...
    <div class="am-u-lg-10 ua2">
      ...
      <ul class="ua2b">
        ...
        <li><span>绑定手机号：</span>12345678910 &nbsp;&nbsp;<a href="#"  data-am-modal="{target:'#usystem_companym1'}">修改</a></li>
      </ul>
  ...
  <div class="am-g ub">
    ...
    <div class="am-u-lg-1">
      <button class="am-btn ubtn-search ubtn-green" data-am-modal="{target:'#usystem_companym2'}">
