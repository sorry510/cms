...
if($intreturn == 0){
	$strsql = "INSERT INTO ".$gdb->fun_table('shop')." (company_id,system_code,shop_name,shop_phone,shop_area_sheng,shop_area_shi,shop_area_address,shop_state,shop_atime,shop_limit_user,shop_edate) VALUES(".$GLOBALS['_SESSION']['login_cid'].",'".$GLOBALS['_SESSION']['login_code']."','".$sqlshop_name."','".$sqlshop_phone."',".$intprovince.",".$intcity.",'".$sqladdress."',1,".$intnow.",5,".$intyear.")";
