...
<div class="gcontent" id="uwechat_config">
  ...
  <form class="am-form">
    ...
    <div class="am-u-lg-12 ua">
      ...
      <div class="am-u-lg-2 ua1 am-text-left am-u-end">88X55mm</div>
    </div>
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">微信预约：</label>
      <div class="am-u-lg-3 ub">
        <label class="am-radio-inline">
          <input type="radio" name="radio1" value="0" data-am-ucheck> 启用
        </label>
    ...
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">微信排号：</label>
      <div class="am-u-lg-3 ub">
        <label class="am-radio-inline">
          <input type="radio" name="radio1" value="0" data-am-ucheck> 启用
        </label>
    ...
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">我的预约：</label> 
      <div class="am-u-lg-8 ub">
        <input class="am-form-field uinput uinput-max" type="text" name="">
      </div>
    </div>
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">我的优惠券：</label> 
      <div class="am-u-lg-8 ub">
        <input class="am-form-field uinput uinput-max" type="text" name="">
      </div>
    </div>
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">到店排号：</label> 
      <div class="am-u-lg-8 ub">
        <input class="am-form-field uinput uinput-max" type="text" name="">
      </div>
    </div>
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">我的排号：</label> 
      <div class="am-u-lg-8 ub">
        <input class="am-form-field uinput uinput-max" type="text" name="">
      </div>
    </div>
    <div class="am-u-lg-12 ua">
      <label class="am-u-lg-2 ua1">门店列表：</label> 
      <div class="am-u-lg-8 ub">
        <input class="am-form-field uinput uinput-max" type="text" name="">
      </div>
    </div>
