		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					...
					<li class="layui-this">
						<a href="wechat_shop_act_discount_add.php">新增打折活动</a>
					</li>
				</ul>
	              	...
	              	?>
								<tr class="laimi-wgoods laimi-use1" wgoods_catalog_id="<?php echo $row['wgoods_catalog_id'];?>" wgoods_id="<?php echo $row2['wgoods_id'];?>" wgoods_price="<?php echo $row2['wgoods_price'];?>">
									...
									<td style="padding:5px">
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="txtgoods_discount[]" placeholder="折" wgoods_price="<?php echo $row2['wgoods_price'];?>">
										</div>
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32" type="text" name="txtgoods_price[]" placeholder="￥" wgoods_price="<?php echo $row2['wgoods_price'];?>">
										</div>
...
<?php echo $this -> fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laydate", "layer", "form"], function() {
		...
		$('.laimi-submitadd').on('click',function(){
		  ...
		  var url="wechat_shop_act_discount_add_do.php";
		  var arr1 = [];
		  var arr2 = [];
