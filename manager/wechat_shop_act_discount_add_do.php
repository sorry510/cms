...
if($intreturn == 0) {
	$strsql = "INSERT INTO " . $gdb->fun_table2('wechat_shop_act_discount') . " (wechat_shop_act_discount_atime, wechat_shop_act_discount_name,  wechat_shop_act_discount_start,  wechat_shop_act_discount_end,  wechat_shop_act_discount_state,  wechat_shop_act_discount_memo) VALUES ("
