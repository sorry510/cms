		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					...
					<li class="layui-this">
						<a href="wechat_shop_act_discount_edit.php">修改打折活动</a>
					</li>
				</ul>
		...
		<div class="layui-col-xs6" style="padding-top:10px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input laimi-input-300" type="text" name="txtname" value="<?php echo $this->_data['edit']['wechat_shop_act_discount_name'];?>">
					<input class="layui-input laimi-input-300" type="hidden" name="txtid" value="<?php echo $this->_data['edit']['wechat_shop_act_discount_id'];?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">开始时间</label>
				<div class="layui-input-inline">
					<input id="laimi-from" class="layui-input" type="text" name="txtstart" placeholder="yyyy-MM-dd" value="<?php echo $this->_data['edit']['wechat_shop_act_discount_start'];?>">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="laimi-to" class="layui-input" type="text" name="txtend" placeholder="yyyy-MM-dd" value="<?php echo $this->_data['edit']['wechat_shop_act_discount_end'];?>">
				</div>
				<div class="layui-form-mid layui-word-aux">
					当天12点结束活动
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea class="layui-textarea laimi-input-b80" name="txtmemo"><?php echo $this->_data['edit']['wechat_shop_act_discount_memo'];?></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-block">
...
<?php echo $this -> fun_fetch('inc_foot', ''); ?>
	...
	layui.use(["element", "laydate", "layer", "form"], function() {
		...
		$(function () {
	      ...
	      if (res[i].wechat_shop_act_discount_goods_value != '0.0') {
	        $("#laimi-discount input[name='txtgoods_discount[]']").each(function() {
	          if ($(this).attr('wgoods_id') == res[i].wgoods_id) {
	            $(this).val(res[i].wechat_shop_act_discount_goods_value);
	          }
	        })
	      }
	      if (res[i].wechat_shop_act_discount_goods_price != '0.00') {
	        $("#laimi-discount input[name='txtgoods_price[]']").each(function() {
	          if ($(this).attr('wgoods_id') == res[i].wgoods_id) {
	            if (res[i].wechat_shop_act_discount_goods_price != '') {
	              $(this).val(res[i].wechat_shop_act_discount_goods_price);
	            }
	          }
	        })
	      }
		...
		$('.laimi-submitadd').on('click',function(){
		  ...
		  var url="wechat_shop_act_discount_edit_do.php";
		  var arr1 = [];
		  var arr2 = [];
		  ...
		  $.post(url,data,function(res){
		    if(res=='0'){
		      window.location="wechat_shop_act_discount.php";
		    }else if(res=='100'){
