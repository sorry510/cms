						...
						<form class="layui-form" action="">
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <input type="text" name="txtwnotice_title" autocomplete="off" class="layui-input" style="width:80%;">
						    </div>
						  </div>						  					  
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <!-- 加载编辑器的容器 -->
							    <script id="container" name="txtwnotice_content" type="text/plain">请填写内容</script>
							    <!-- 配置文件 -->
