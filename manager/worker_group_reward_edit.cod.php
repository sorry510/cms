	...
	<div class="layui-row">
		<div class="layui-col-xs6" style="padding-top:10px;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" name="filltype" value="1" title="百分比(%)" <?php if($this->_data['reward_list']['group_reward_pfill']!=0) echo "checked"?>>
					<input type="radio" name="filltype" value="2" title="固定金额(元)" <?php if($this->_data['reward_list']['group_reward_fill']!=0) echo "checked"?>>
				</div>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" name="guidetype" value="1" title="百分比(%)" <?php if($this->_data['reward_list']['group_reward_pguide']!=0) echo "checked"?>>
					<input type="radio" name="guidetype" value="2" title="固定金额(元)" <?php if($this->_data['reward_list']['group_reward_guide']!=0) echo "checked"?>>
				</div>
				<div class="layui-input-inline">
                      	...
                      	<?php } ?>
								...
								<tr class="laimi-mgoods" catalog="<?php echo $row['mgoods_catalog_id']?>">
									...
									<td style="padding:5px">
										<div class="layui-inline">
											<input class="layui-input laimi-input-60-32 laimi-percent" type="text" name="txtpercent" placeholder="%" price="<?php echo $row2['mgoods_price'];?>" price="<?php echo $row2['mgoods_price'];?>" value="<?php echo $row2['group_reward2_percent'];?>">
										</div>
										<div class="layui-inline">
