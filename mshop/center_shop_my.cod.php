...
<div id="laimi-content" class="mui-content">
    ...
    <div class="mui-table-view-cell">
    	<span class="mui-badge mui-badge-inverted" style="font-size:14px;"><?php  echo $this->_data['card_info']['card_name']; ?></span>
				微信昵称
    ...
    <div class="mui-input-row">
        <label>会员姓名</label>
    <input type="text" name="cardname" style="text-align: right;font-size: 14px;color:#929292;"  placeholder="请输入姓名" value="<?php echo $this->_data['card_info']['card_name']; ?>">
    </div>
		<div class="mui-table-view-cell">
...
<script type="text/javascript" charset="utf-8">
  ...
  mui.ready(function(){
    ...
    mui('.laimi-phone')[0].addEventListener('click', function() {
      var phone = "<?php if(!empty($this->_data['card_info']))echo $this->_data['card_info']['card_phone']; ?>";
      if(phone == ''){
        show();
      }
    }, false);
