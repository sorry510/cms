			...
			if(res.list.length > 0){
				...
				mui.each(res.list, function(k, v){
					...
					html += '<a href="detail.php?id='+v.wgoods_id+'">'+
						        '<img class="mui-media-object mui-pull-left" style="max-width:100px;height:100px;" src="read_image.php?c=<?php echo $GLOBALS["_SESSION"]["login_cid"];?>&type=wgoods&image='+v.photo+'">'+
						        '<div class="mui-media-body" style="white-space:normal;">'+v.wgoods_name+
						        	'<p class="laimi-font12">'+v.wgoods_name2+'</p>'+
						        	'<p style="color:#CF2D28;font-size:12px;margin-top:3px;line-height:30px;">¥<span style="font-size:20px;">120</span>&nbsp;';
