		...
		<ul class="mui-table-view laimi-table-view">
			...
			<li class="mui-table-view-cell">				
				<div class="mui-media-body">
					<img src="<?php echo "read_image.php?c=".$GLOBALS['_SESSION']['login_cid']."&type=wgoods&image=".$row2['c_wgoods_photo1'] ;?>" style="height: 40px;width:40px;float:left;margin-right:10px;border-radius:3px;"/>
