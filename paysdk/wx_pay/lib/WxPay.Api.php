...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid($GLOBALS['arrwpay']['weixin_appid']);//公众账号ID
		$inputObj->SetMch_id($GLOBALS['arrwpay']['weixin_mchid']);//商户号
		$inputObj->SetSub_Mch_id($GLOBALS['arrwpay']['weixin_sub_mchid']);//子商户号
