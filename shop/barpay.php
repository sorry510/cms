...
// require_once C_ROOT .'/paysdk/ali_pay/dangmianfu/AopSdk.php';
header("Content-type: text/html; charset=utf-8");
// require_once C_ROOT .'/paysdk/ali_pay/dangmianfu/f2fpay/model/builder/AlipayTradePayContentBuilder.php';
// require_once C_ROOT .'/paysdk/ali_pay/dangmianfu/f2fpay/service/AlipayTradeService.php';
        ...
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <dd>
                    ...
                    <input size="30" name="out_trade_no" value="test<?php echo time()."_".rand(1,1000);?>"/>
                ...
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="subject" value="test"/>
						<span>必填
</span>
                </dd>
