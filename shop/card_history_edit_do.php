...
$strcard_history_id = api_value_post('txthistory');
...
$strsql = "SELECT card_history_id FROM ".$gdb->fun_table2('card_history')." WHERE card_history_id=".$intcard_history_id." and shop_id=".$intshop;
...
if($intreturn == 0){
	$strsql = "UPDATE ".$gdb->fun_table2('card_history')." SET worker_id=".$intworker_id.",card_history_question='".$sqlquestion."',card_history_result='".$sqlresult."',card_history_plan='".$sqlplan."',c_worker_name='".$worker_name."', where card_history_id=".$intcard_history_id;
