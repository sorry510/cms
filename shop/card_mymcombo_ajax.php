...
$strsql1 = "SELECT card_mcombo_atime FROM ".$GLOBALS['gdb']->fun_table2('card_mcombo')." WHERE card_id = ".$intcard_id." group by card_mcombo_atime having sum(card_mcombo_gcount)!=0";
