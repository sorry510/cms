...
if($intreturn == 0){
	$strsql = "UPDATE ".$gdb->fun_table2('cash')." SET cash_state=".$intcash_state.",cash_name='".$sqlcash_name."',cash_type_id=".$intcash_type_id.",cash_money=".$deccash_money.",cash_time=".$intcash_time.",cash_memo='".$sqlcash_memo."' where cash_id=".$intcash_id;
