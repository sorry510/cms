...
<blockquote class="layui-elem-quote" style="margin-top:20px;">
  <div class="layui-row">
    <div class="layui-col-md2">
      <div class="layui-bg-orange layui-circle" style="width:120px;height:120px;margin:0 auto;"><span style="line-height:120px;margin-left:40px;font-size:22px;">收入</span></div>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;">    	
    </div>
    ...
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;margin-right:30px;">
	...
	<div class="layui-col-md2" style="line-height:25px;margin-top:15px;">
    	<ul>
...
<blockquote class="layui-elem-quote" style="margin-top:20px;">
  <div class="layui-row">
    <div class="layui-col-md2">
      <div class="layui-bg-blue layui-circle" style="width:120px;height:120px;margin:0 auto;"><span style="line-height:120px;margin-left:40px;font-size:22px;">消费</span></div>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;">    	
    </div>
    <div class="layui-col-md3" style="line-height:26px;margin-top:30px;">
    	<ul>
    		<li style="text-align:center;"><span style="font-size:32px;font-weight:bold;" class="laimi-color-ju">12</span><span class="laimi-color-ju">次</span></li>
    		<li class="laimi-color-hui" style="text-align:center;">消费次数 </li>
    	</ul>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;margin-right:30px;">    	
    </div>
    <div class="layui-col-md4" style="line-height:25px;margin-top:10px;">
    	<ul>
...
<blockquote class="layui-elem-quote" style="margin-top:20px;">
  <div class="layui-row">
    <div class="layui-col-md2">
      <div class="layui-bg-green layui-circle" style="width:120px;height:120px;margin:0 auto;"><span style="line-height:120px;margin-left:40px;font-size:22px;">会员</span></div>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;">    	
    </div>
    <div class="layui-col-md3" style="line-height:26px;margin-top:30px;">
    	<ul>
    		<li style="text-align:center;"><span style="font-size:32px;font-weight:bold;" class="laimi-color-ju">1200</span><span class="laimi-color-ju">人</span></li>
    ...
    <div class="layui-col-md6" style="line-height:25px;margin-top:10px;">
    	<ul>
...
<blockquote class="layui-elem-quote" style="margin-top:20px;">
  <div class="layui-row">
    <div class="layui-col-md2">
      <div class="layui-bg-cyan layui-circle" style="width:120px;height:120px;margin:0 auto;"><span style="line-height:120px;margin-left:40px;font-size:22px;">商品</span></div>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;">    	
    </div>
    <div class="layui-col-md3" style="line-height:26px;margin-top:38px;">
    	<ul>
    		<li style="text-align:center;"><span class="laimi-color-ju" style="font-size: 18px;">¥</span><span style="font-size:32px;font-weight:bold;" class="laimi-color-ju">16800.00</span></li>
    		<li class="laimi-color-hui" style="text-align:center;">商品销售额 </li>
    	</ul>
    </div>
    <div class="layui-col-md1" style="height:120px;background-color:#DDDDDD;width:1px;margin-right:30px;"></div>
    <div class="layui-col-md6" style="line-height:25px;margin-top:30px;">
    	<ul>
    		<li><span class="layui-text">商品销售额：</span><span class="laimi-color-ju">¥168.00</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color:#004C96;font">查看商品销售排名</a></li>
