...
<script type="text/javascript" language="javascript">
	...
	function CreateOnePage(){
		...
		var title = '<?php echo $this->_data['print_info']['print_title']; ?>';
		var width = 580;
		var widthindex = '<?php echo $this->_data['print_info']['print_width']; ?>';
		if(widthindex == 1){
			width = 580;
		}else if(widthindex == 2){
			width = 880;
		}
		var device = '<?php echo $this->_data['print_info']['print_device']; ?>';
