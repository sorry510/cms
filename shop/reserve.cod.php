  ...
  <div class="gspace15"></div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button class="am-btn ubtn-table ubtn-green chere" value="<?php echo $row['reserve_id']; ?>">
...
function searchGoods(){
    ...
    var data = {};
    if(type=='add'){
      $("#ureservem2 #tab1 .uc li").hide();
      data={
        type: $("#ureservem2 #tab1 .cgoods_type").val(),
        search:$("#ureservem2 #tab1 .cgoods_name").val()
      };
    }else{
      ...
      if(res){
        if(type=='add'){
          $.each(res, function(key, val) {
            $("#ureservem2 #tab1 .uc li[mgoods_type]").each(function(){
              //console.log($(this).attr('mgoods_type'));
              if($(this).attr('mgoods_type')==val.mgoods_catalog_id){
                $(this).show();
              }
            });
            $("#ureservem2 #tab1 .uc li[sgoods_type]").each(function(){
            ...
            if(val.mgoods!=undefined){
              $.each(val.mgoods, function(key,val){
                $("#ureservem2 #tab1 .uc li[mgoods_id]").each(function(){
            ...
            if(val.sgoods!=undefined){
              $.each(val.sgoods, function(key,val){
                $("#ureservem2 #tab1 .uc li[sgoods_id]").each(function(){
