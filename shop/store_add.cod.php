                  ...
                  <option value="<?php echo 's-'.$row['sgoods_catalog_id']; ?>"><?php echo $row['sgoods_catalog_name']; ?></option>
					...
					<tr class="laimi-goods" gtype="m" catalog="<?php echo $row['mgoods_catalog_id']; ?>" gcode="<?php echo $row2['mgoods_code']; ?>" gname="<?php echo $row2['mgoods_name']; ?>" gshort="<?php echo $row2['mgoods_jianpin']; ?>">
						...
						<td style="padding:5px">
							<div class="layui-inline">
								<input class="layui-input laimi-input-60-32 laimi-number" type="text" name="txtnum" price="<?php echo $row2['mgoods_price'];?>" gname="<?php echo $row2['mgoods_name']; ?>" catalog="<?php echo $row['mgoods_catalog_id']?>" mgoods="<?php echo $row2['mgoods_id']?>">
							</div>
						</td>
					</tr>
						<?php }?>
					...
					<tr class="laimi-goods" gtype="s" catalog="<?php echo $row['sgoods_catalog_id']; ?>" code="<?php echo $row2['sgoods_code']; ?>" gname="<?php echo $row2['sgoods_name']; ?>" gshort="<?php echo $row2['sgoods_jianpin']; ?>">
						...
						<td style="padding:5px">
							<div class="layui-inline">
								<input class="layui-input laimi-input-60-32 laimi-number" type="text" name="txtnum" price="<?php echo $row2['sgoods_price'];?>" gname="<?php echo $row2['sgoods_name']; ?>" catalog="<?php echo $row['sgoods_catalog_id']?>" sgoods="<?php echo $row2['sgoods_id']?>">
							</div>
						</td>
					</tr>
						<?php }?>
	...
	layui.use(["element", "laydate", "form"], function() {
		...
		objform.on("submit(laimi-submit)", function(data) {
	      ...
	      store_memo: data.field.memo,
			...
			$.post('store_add_do.php', postdata, function(res){
				console.log(res);
			  if(res=='0'){
