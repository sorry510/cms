...
$struser_password_old = api_value_post('passwordold');
$sqluser_password_old = $gdb->fun_escape($struser_password_old);
$struser_password = api_value_post('password');
$sqluser_password = $gdb->fun_escape($struser_password);
$struser_password2 = api_value_post('password2');
$sqluser_password2 = $gdb->fun_escape($struser_password2);
$struser_id = api_value_post('id');
