		...
		<div id="laimi-content" class="layui-body">
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					<li class="layui-this">代金券管理</li>
				</ul>
				<div class="layui-tab-content">
					<form class="layui-form" action="">		    
		 		 <div class="layui-form-item">		  	
		      <label class="layui-form-label laimi-input" style="width: 80px;">代金券名称</label>
		    ...
		    <div class="layui-inline laimi-float-right">
		    	<a id="laimi-modal" href="javascript:;" class="layui-btn">新增代金券</a>
		  	</div>		  		    
		  </div>
		  </form>		  
		...
		<form class="layui-form" action="">
			<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="price_min" placeholder="￥" lay-verify="title" autocomplete="off" class="layui-input laimi-input-100">
					</div>
					<div class="layui-form-mid layui-word-aux">元</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">消费限额</label>
					<div class="layui-input-inline">
						<input type="text" name="price_min" placeholder="￥" lay-verify="title" autocomplete="off" class="layui-input laimi-input-100">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="radio" name="sex" value="当天开始" title="当天开始" checked="">
      			<input type="radio" name="sex" value="第二天开始" title="第二天开始">
					</div>
				</div>
				<div class="layui-form-item">
