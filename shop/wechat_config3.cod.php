					...
					<div class="layui-tab-content">
						<form class="layui-form" action="">													
							...
							<div class="layui-form-item">
								...
								<div class="layui-form-mid" style="color: #FF5722;">请先在公众号设置里填入公众号信息，再来此页面复制代码</div>
							</div>								
							<div class="layui-form-item">
								<label class="layui-form-label">会员中心</label>
								<div class="layui-input-block">
									<textarea placeholder="" disabled class="layui-textarea laimi-input-b80" style="line-height: 22px;">https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http%3A%2F%2Fshop1.e8860.com%2Ffw%2Fweixin%2Fs_oauth2.php%3Ftid%3D %26url%3Dm11.php&response_type=code&scope=snsapi_base#wechat_redirect</textarea>
								</div>
							</div>
							<div class="layui-form-item">
