...
<div class="am-modal" tabindex="-1" id="uworker_rewardm1">
  <div class="am-modal-dialog umodal umodal-simple">
    <div class="am-modal-hd uhead"><span class="cname"></span>本店提成方案
...
<div class="am-modal" tabindex="-1" id="uworker_rewardm2">
  <div class="am-modal-dialog umodal">
    <div class="am-modal-hd uhead">本店提成方案
      <a href="javascript: void(0)" class="am-close am-close-spin uclose" data-am-modal-close><img src="../img/close.jpg"></a>
    </div>
...
$('#uworker_rewardm1 .cguide_type').on('change', function() {
  if($(this).val()==1){
...
$('#uworker_rewardm1 .cfill_type').on('change', function() {
  if($(this).val()==1){
